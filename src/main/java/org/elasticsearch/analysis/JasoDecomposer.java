            ...
            for(int i = 0; i < termBuffer. length; i++) {
                ...
                if(jaso) {
                    ...
                    if(ch >= 0xAC00 && ch <= 0xD7A3) {
                        ...
                        //복자음 강제분리
                        switch(ch) {
                            case 'ㄲ': etcBuffer.append("ㄱㄱ"); break;
                            case 'ㄳ': etcBuffer.append("ㄱㅅ"); break;
                            case 'ㄵ': etcBuffer.append("ㄴㅈ"); break;
                            case 'ㄶ': etcBuffer.append("ㄴㅎ"); break;
                            case 'ㄺ': etcBuffer.append("ㄹㄱ"); break;
                            case 'ㄻ': etcBuffer.append("ㄹㅁ"); break;
                            case 'ㄼ': etcBuffer.append("ㄹㅂ"); break;
                            case 'ㄽ': etcBuffer.append("ㄹㅅ"); break;
                            case 'ㄾ': etcBuffer.append("ㄹㅌ"); break;
                            case 'ㄿ': etcBuffer.append("ㄹㅍ"); break;
                            case 'ㅀ': etcBuffer.append("ㄹㅎ"); break;
                            case 'ㅄ': etcBuffer.append("ㅂㅅ"); break;
                            default: etcBuffer.append(ch);
                        }
                    } else {
                        etcBuffer.append(ch);
                    }
